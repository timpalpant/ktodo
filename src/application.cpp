...
void Application::setProjectDescription(const QString &id, const QString &description)
{
    m_repo->updateProject(id, QJsonObject{{QStringLiteral("description"), description}});
    touch();
}
